...
Route::get('payment/detect', 'PaymentController@detectPayment')->middleware('jwt.auth');
Route::get('payment/apply/{id}', 'PaymentController@applyPayment')->middleware('jwt.auth');
