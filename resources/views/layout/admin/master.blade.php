...
<head>
    ...
    <link rel="stylesheet" href="{{ secure_asset('font-awesome-4.7.0/css/font-awesome.css') }}" />
    <link rel="stylesheet" href="{{ secure_asset('node_modules/perfect-scrollbar/dist/css/perfect-scrollbar.min.css') }}" />
