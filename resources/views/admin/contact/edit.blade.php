            ...
            <div class="card">
                <div class="card-block">
                    ...
                    <fieldset class="form-group">
                        ...
                        @if(count($contact->products))
                            {!! Form::text('products', implode(', ', $contact->products), ['class'=>'form-control', 'placeholder'=>'Separate with commas...']) !!}
                        @else
                            {!! Form::text('products', NULL, ['class'=>'form-control', 'placeholder'=>'Separate with commas...']) !!}
                        @endif
                    ...
                    <div class="row">
                        <div class="col">
                            <fieldset class="form-group">
                                ...
                                {!! Form::text('lng', $contact->lng, ['class'=>'form-control', 'placeholder'=>'Enter longitude...']) !!}
                                @if($errors->has('lng'))
                                    <small class="text-danger">
                        ...
                        <div class="col">
                            <fieldset class="form-group">
                                ...
                                {!! Form::text('lat', $contact->lat, ['class'=>'form-control', 'placeholder'=>'Enter latitude...']) !!}
                                @if($errors->has('lat'))
                                    <small class="text-danger">
